...
import com.nyora.hasan72341.core.ui.anim.NyoraTransitions
...
import com.nyora.hasan72341.bookmarks.ui.AllBookmarksFragment
...
import com.nyora.hasan72341.core.util.ext.setContentDescriptionAndTooltip
import com.nyora.hasan72341.core.util.ext.smoothScrollToTop
import com.nyora.hasan72341.databinding.NavigationRailFabBinding
import com.nyora.hasan72341.explore.ui.ExploreFragment
...
class MainNavigationDelegate(
	...
	private fun onNavigationItemSelected(@IdRes itemId: Int): Boolean {
		val newFragment = when (itemId) {
			...
			R.id.nav_feed -> DiscoverFragment::class.java
	...
	private fun getItemId(fragment: Fragment) = when (fragment) {
		...
		is DiscoverFragment -> R.id.nav_feed
	...
	private fun setPrimaryFragment(fragmentClass: Class<out Fragment>): Boolean {
		...
		fragment.enterTransition = MaterialFadeThrough().apply {
			duration = NyoraTransitions.DURATION_SHORT
		}
	...
	private fun observeSettings(lifecycleOwner: LifecycleOwner) {
		settings.observe(AppSettings.KEY_TRACKER_ENABLED, AppSettings.KEY_NAV_LABELS)
			.onEach {
