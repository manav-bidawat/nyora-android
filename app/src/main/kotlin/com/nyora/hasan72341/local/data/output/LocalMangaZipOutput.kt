...
import com.nyora.hasan72341.core.util.ext.readText
import com.nyora.hasan72341.core.zip.ZipOutput
...
class LocalMangaZipOutput(
	...
	companion object {
		...
		suspend fun filterChapters(file: File, manga: Manga, idsToRemove: Set<String>) =
			runInterruptible(Dispatchers.IO) {
