...
import com.nyora.hasan72341.core.util.ext.awaitUniqueWorkInfoByName
...
import com.nyora.hasan72341.core.util.ext.flatten
...
import com.nyora.hasan72341.core.util.ext.takeMostFrequent
import com.nyora.hasan72341.core.util.ext.toBitmapOrNull
import com.nyora.hasan72341.core.util.ext.trySetForeground
...
import com.nyora.hasan72341.settings.work.PeriodicWorkScheduler
import com.nyora.hasan72341.suggestions.domain.MangaSuggestion
...
class SuggestionsWorker @AssistedInject constructor(
		...
		if (appSettings.isSuggestionsNotificationAvailable
			...
			for (i in 0..3) {
				try {
					...
					val details = mangaRepositoryFactory.create(com.nyora.hasan72341.core.model.MangaSource(manga.manga.source.name))
	...
	private suspend fun getList(
		...
		val tag = tags.firstNotNullOfOrNull { title ->
			availableTags.find { x ->
				MangaTag(key = x.key, title = x.title) !in blacklist &&
					x.title.almostEquals(title, TAG_EQ_THRESHOLD)
			}
		}
			...
			setLargeIcon(
				coil.execute(
					ImageRequest.Builder(applicationContext)
						.data(manga.coverUrl)
						.mangaSourceExtra(com.nyora.hasan72341.core.model.MangaSource(manga.source.name))
						.build(),
				).toBitmapOrNull(),
			)
	...
	private fun computeRelevance(mangaTags: List<MangaTag>, allTags: List<String>): Float {
	...
	private companion object {
		...
		const val GROUP_SUGGESTION = "com.nyora.hasan72341.SUGGESTIONS"
