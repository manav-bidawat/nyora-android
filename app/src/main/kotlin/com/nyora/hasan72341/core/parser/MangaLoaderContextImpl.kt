...
import com.nyora.hasan72341.core.network.webview.WebViewRequestInterceptorExecutor
import com.nyora.hasan72341.mihon.parsers.webview.InterceptedRequest
import com.nyora.hasan72341.mihon.parsers.webview.InterceptionConfig as ParsersInterceptionConfig
import com.nyora.hasan72341.mihon.parsers.network.UserAgents
import com.nyora.hasan72341.mihon.parsers.util.map
...
class MangaLoaderContextImpl @Inject constructor(
    ...
    override suspend fun interceptWebViewRequests(
        ...
        val config = com.nyora.hasan72341.core.network.webview.InterceptionConfig(
            timeoutMs = timeout,
            maxRequests = 100,
    ...
    override suspend fun interceptWebViewRequests(
        ...
        val appConfig = com.nyora.hasan72341.core.network.webview.InterceptionConfig(
