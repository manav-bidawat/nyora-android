...
import com.nyora.hasan72341.core.exceptions.BadBackupFormatException
import com.nyora.hasan72341.core.exceptions.CaughtException
...
import com.nyora.hasan72341.core.exceptions.NonFileUriException
...
import com.nyora.hasan72341.core.exceptions.UnsupportedFileException
import com.nyora.hasan72341.core.exceptions.UnsupportedSourceException
import com.nyora.hasan72341.core.exceptions.WrapperIOException
...
import com.nyora.hasan72341.mihon.parsers.ErrorMessages.FILTER_BOTH_LOCALE_GENRES_NOT_SUPPORTED
import com.nyora.hasan72341.mihon.parsers.ErrorMessages.FILTER_BOTH_STATES_GENRES_NOT_SUPPORTED
import com.nyora.hasan72341.mihon.parsers.ErrorMessages.FILTER_MULTIPLE_GENRES_NOT_SUPPORTED
import com.nyora.hasan72341.mihon.parsers.ErrorMessages.FILTER_MULTIPLE_STATES_NOT_SUPPORTED
import com.nyora.hasan72341.mihon.parsers.ErrorMessages.SEARCH_NOT_SUPPORTED
...
fun Throwable.report(silent: Boolean = false) {
	...
	if (!silent) {
		...
		Log.e("Nyora", "Exception reported", exception)
	} else if (!BuildConfig.DEBUG) {
		exception.printStackTrace()
		Log.w("Nyora", "Silent exception reported", exception)
	}
}
...
fun FileNotFoundException.parseMessage(resources: Resources): String? {
    ...
    /storage/0000-0000/Android/media/d1f08350-0c25-460b-8f50-008e49de3873.jpg.tmp: open failed: EROFS (Read-only file system)
     /storage/emulated/0/Android/data/com.nyora.hasan72341/cache/pages/fe06e192fa371e55918980f7a24c91ea.jpg: open failed: ENOENT (No such file or directory)
     /storage/0000-0000/Android/data/com.nyora.hasan72341/files/manga/e57d3af4-216e-48b2-8432-1541d58eea1e.tmp (I/O error)
     */
    val groups = FNFE_MESSAGE_REGEX.matchEntire(message ?: return null)?.groupValues ?: return null
