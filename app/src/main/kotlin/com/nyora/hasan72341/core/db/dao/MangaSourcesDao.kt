...
import com.nyora.hasan72341.mihon.parsers.network.CloudFlareHelper.PROTECTION_CAPTCHA
...
abstract class MangaSourcesDao {
	...
	// cf_state = 1 is CloudFlareHelper.PROTECTION_CAPTCHA (inlined — Room @Query can't
	// reference Kotlin constants / string templates under the KSP2 processor).
	@Query("SELECT * FROM sources WHERE cf_state = 1")
