...
import com.nyora.hasan72341.core.model.chaptersCount
...
import com.nyora.hasan72341.core.util.ext.concat
...
class AutoFixUseCase @Inject constructor(
	...
	suspend operator fun invoke(mangaId: String): Pair<Manga, Manga?> {
	...
	private suspend fun Manga.isHealthy(): Boolean = runCatchingCancellable {
		val repo = mangaRepositoryFactory.create(source.toMangaSource())
		val details = if (this.chapters.isNotEmpty()) this else repo.getDetails(this)
