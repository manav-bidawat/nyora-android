...
import com.nyora.hasan72341.core.ui.image.ChipIconTarget
...
import com.nyora.hasan72341.databinding.ItemMangaAlternativeBinding
...
fun alternativeAD(
	...
	bind { payloads ->
		...
		binding.chipSource.also { chip ->
			val source = item.manga.source.toMangaSource()
			chip.text = source.getTitle(chip.context)
