...
import com.nyora.hasan72341.core.util.ext.toUUIDOrNull
...
class PausingReceiver(
	...
	companion object {
		...
		private const val ACTION_PAUSE = "com.nyora.hasan72341.download.PAUSE"
		private const val ACTION_RESUME = "com.nyora.hasan72341.download.RESUME"
		private const val ACTION_SKIP = "com.nyora.hasan72341.download.SKIP"
		private const val ACTION_SKIP_ALL = "com.nyora.hasan72341.download.SKIP_ALL"
