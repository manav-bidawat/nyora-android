...
fun Page.asContentPage(
    ...
    val pageId = "${chapter.url}|page|$index"
 ...
 */
private fun generateContentId(url: String, sourceName: String): String {
 ...
 */
private fun generateChapterId(url: String, sourceName: String): String {
    return "$sourceName|chapter|$url"
}
