...
import com.nyora.hasan72341.core.ui.list.lifecycle.PagerLifecycleDispatcher
import com.nyora.hasan72341.core.util.ext.doOnPageChanged
import com.nyora.hasan72341.core.util.ext.findCurrentViewHolder
import com.nyora.hasan72341.core.util.ext.observe
import com.nyora.hasan72341.core.util.ext.recyclerView
import com.nyora.hasan72341.core.util.ext.resetTransformations
import com.nyora.hasan72341.databinding.FragmentReaderPagerBinding
import com.nyora.hasan72341.reader.domain.PageLoader
import com.nyora.hasan72341.reader.ui.ReaderState
import com.nyora.hasan72341.reader.ui.pager.standard.NoAnimPageTransformer
import com.nyora.hasan72341.reader.ui.pager.standard.PageAnimTransformer
import com.nyora.hasan72341.reader.ui.pager.standard.PageHolder
import com.nyora.hasan72341.reader.ui.pager.standard.PagerEventSupplier
import com.nyora.hasan72341.reader.ui.pager.standard.PagesAdapter
...
abstract class BasePagerReaderFragment : BaseReaderFragment<FragmentReaderPagerBinding>(),
	...
	override fun translatePageAt(index: Int) {
		...
		(rv?.findViewHolderForAdapterPosition(index) as? BasePageHolder<*>)?.translatePage()
	}
