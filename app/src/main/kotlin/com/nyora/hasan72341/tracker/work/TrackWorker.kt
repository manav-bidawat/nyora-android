package com.nyora.hasan72341.tracker.work
...
import com.nyora.hasan72341.core.util.ext.onEachIndexed
...
import com.nyora.hasan72341.tracker.domain.GetTracksUseCase
...
import com.nyora.hasan72341.tracker.work.TrackerNotificationHelper.NotificationInfo
			...
			TrackerDownloadStrategy.DOWNLOADED -> {
				...
				if (localManga != null) {
					val task = DownloadTask(
						...
						isPaused = false,
						isSilent = false,
						chaptersIds = mangaUpdates.newChapters.map { it.id }.toTypedArray(),
						destination = null,
						format = null,
