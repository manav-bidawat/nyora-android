...
class StaticItemSizeResolver(
	...
	private var textAppearanceResId = R.style.TextAppearance_Nyora_GridTitle
	...
	override fun attachToView(
		...
		if (widthThreshold == -1) {
			...
			textAppearanceResId = if (cellWidth < widthThreshold) {
				R.style.TextAppearance_Nyora_GridTitle_Small
			} else {
				R.style.TextAppearance_Nyora_GridTitle
			}
		}
		if (textView != null) {
