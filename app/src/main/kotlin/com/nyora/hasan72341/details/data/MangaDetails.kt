package com.nyora.hasan72341.details.data
...
import com.nyora.hasan72341.reader.data.filterChapters
...
data class MangaDetails(
    ...
    fun getLocale(): Locale? {
        ...
        return manga.source.toMangaSource().getLocale()
    }
