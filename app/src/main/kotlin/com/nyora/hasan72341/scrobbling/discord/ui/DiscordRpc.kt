package com.nyora.hasan72341.scrobbling.discord.ui
			...
			updateRpcAsync(
				activity = Activity(
					...
					buttons = listOf(
						...
						context.getString(R.string.read_on_s, com.nyora.hasan72341.core.model.MangaSource(manga.source.name).getTitle(context)),
					),
